    ...
    try:#Exception handling 
        ...
        if req.status_code == 200: #Status code 200 indicates a successful request
            ...
            for n,i in enumerate(search_result): #iterating through the search results
                ...
                single_result = pd.DataFrame({"Title": url_txt, "URL": href, "Description": description})result_df = result_df.concat([pd.DataFrame({"Title": url_txt, "URL": href, "Description": description}, index=[n])])
